...
struct class_Obj_struct {
  ...
  obj_Boolean (*EQUAL) (obj_Obj, obj_Obj);
...
struct class_Boolean_struct {
  ...
  obj_Boolean (*EQUAL) (obj_Obj, obj_Obj); /* Inherit */
  obj_Obj (*PRINT) (obj_Obj);               /* Inherit */
  obj_Boolean (*EQUALS) (obj_Boolean, obj_Boolean);
...
struct class_Int_struct {
  ...
  obj_Boolean (*EQUALS) (obj_Int, obj_Int); /* Introduced */
};
